...
export function ServicesPage() {
  ...
  useSeo({
    title: 'Custom Ironwork, Fire Pits & Rocket Stoves in Utah | D&S Iron Works',
    description: 'Explore D&S Iron Works services: custom ironwork, pre-built fire pits, rocket stoves, forged railings, metal signs, forged metal art, and blacksmith commissions in Utah.',
    path: '/services',
    jsonLd: {
        ...
        <div className="container mx-auto px-5 sm:px-6 md:px-12 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            ...
            <p className="text-white/55 max-w-md font-sans font-light leading-relaxed">
              D&S Iron Works builds custom fire pits, pre-built fire pits, rocket stoves,
